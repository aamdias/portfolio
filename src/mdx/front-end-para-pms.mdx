...
Mas deixando o meu bom gosto de lado, essa tela tem muitas - mas muitas mesmo - funcionalidades que exigiram o uso de inúmeras tecnologias. Exemplos de funcionalidades contidas nesta tela:
...
Tendo em vista isso, todas essas funcionalidades que eu citei e descrevi com exemplos, o que comumente é escopo de Front-End e o que é escopo de outras camadas (como Back-End e Banco de Dados)? Organizei isso no seguinte diagrama:
